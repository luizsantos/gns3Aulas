...
# Esse script é para ser utilizado apenas nos laboratórios da UTFPR. Não é para ser executados por alunos. Para executar tal script é necessário que já esteja instalado o GNS3, libvirt, etc. Na dúvida converse com o professor. USE POR SUA CONSTA E RISCO!

# to execute:
# $ sh install_UTFPR_labs.sh
# or
# $ ./install_UTFPR_labs.sh
eco="/bin/echo -e"
dirUsu="/home/aluno"
